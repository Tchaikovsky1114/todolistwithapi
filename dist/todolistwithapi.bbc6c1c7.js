...
},{}],"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/isarray/index.js":[function(require,module,exports) {
...
},{}],"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/base64-js/index.js","ieee754":"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/ieee754/index.js","isarray":"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/isarray/index.js","buffer":"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/axios/lib/helpers/toFormData.js":[function(require,module,exports) {
...
},{"../utils":"node_modules/axios/lib/utils.js","buffer":"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/axios/lib/core/settle.js":[function(require,module,exports) {
'use strict';
...
},{}],"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
var showProgressingListButton = document.querySelector("#todos--remote-show-progressinglist-button"); // 이벤트 바인딩 상단 배치 (
// 상단에 배치하는건 케바케 함수 표현식이면 호이스팅 문제가 있기 때문 그래도 한쪽에 몰아넣어서 알아보기 쉽게 구성
...
}); // API 요청에 필요한 정보들은 상수로 선언해서 사용하기

var API_URL = "https://asia-northeast3-heropy-api.cloudfunctions.net/api/todos";
var API_KEY = "FcKdtJs202204";
var USER_NAME = "KimMyungSeong"; // 렌더링에 필요한 전역변수 todos, 그외 loading, todosValue 필요 없는 전역 변수 제거

var todos = []; // 공통으로 사용할 수 있는 custom axios util 함수
// default 매개변수 지정
...
function _request() {
  _request = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee(_ref) {
...
function _onInit() {
  _onInit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee2() {
...
function _getTodo() {
  _getTodo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee3() {
    var response;
...
function postTodo(_x2, _x3) {
  return _postTodo.apply(this, arguments);
} // axios.delete 분리


function _postTodo() {
  _postTodo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee4(todosValue, orderNumber) {
    var response;
    ...
    return _regeneratorRuntime.default.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            // button에 value로 각 아이템의 id를 넣었기 때문에 이를 이용해 delete
          ...
          case 4:
            ...
            // 렌더링에 이용되는 전역 변수 todos에서 filter를 이용해 제거
...
function putTodo(_x5) {
  return _putTodo.apply(this, arguments);
} // validate


function _putTodo() {
  _putTodo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee6(item) {
    var title, order, done, id, response, currentIdx;
    return _regeneratorRuntime.default.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            title = item.title, order = item.order, done = item.done, id = item.id;
            _context6.prev = 1;
            _context6.next = 4;
            return request({
          ...
          case 4:
            ...
            // todos에서 현재 선택 todo index 가져옴
            currentIdx = todos.findIndex(function (item) {
              return item.id === id;
            }); // todos 기존 데이터 변경

            todos[currentIdx] = _objectSpread(_objectSpread({}, todos[currentIdx]), {}, {
              title: title,
              order: order,
              done: !done
            });
...
function onSubmitTodo(e) {
  ...
  if (todosInputEl.value.length < 10) {
    alert("누가 목표는 자세히 써야 실천 한다고 하더라고요(10자 이상 입력)");
    return;
  }

  createTodo(todosInputEl.value);
  todosInputEl.value = "";
  todosInputEl.focus();
}

function countTodoListChildNode() {
  // append보다 innerHTML이 좀 더 깔끔띠 합니다?
  if (!todos.length) {
    todoList.innerHTML = "\n      <div>\uC544\uBB34 \uACC4\uD68D\uB3C4 \uC5C6\uC2B5\uB2C8\uB2E4...</div>\n    ";
  }
...
} // readTodo 매번 axios.get하기에는 리소스 부담이 커서 전역 변수 todos로 화면 그려주는 역할
...
function changeTodoTitle(_x8) {
  return _changeTodoTitle.apply(this, arguments);
} // 들여쓰기로 태그 인지할 수 있게 수정 및 button에다 value로 todo.id 넣기


function _changeTodoTitle() {
  _changeTodoTitle = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee9(e) {
    var _yield$axios, data, todosTitleArray, todosTitle, todosIndex, todoCard, updateInputBox, todosUpdateCancelButton, todosIdArray, todosOrderArray, todosDoneArray;
...
function _renderTodos() {
  _renderTodos = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee10() {
    var str,
        todoElements,
        todoTitles,
        doneToggleButtons,
    ...
    return _regeneratorRuntime.default.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            str = _args10.length > 0 && _args10[0] !== undefined ? _args10[0] : "작성";
            console.log(todos);
            _context10.next = 4;
            return todos.map(function (todo) {
              return "\n    <li class=\"todo\">\n      <div class=\"todos--title\">".concat(todo.title, "</div>\n      <span>\n        (").concat(todo.updatedAt.substr(2, 2), "-").concat(todo.updatedAt.substr(5, 2), "\n          - ").concat(todo.updatedAt.substr(8, 2), " ").concat(todo.updatedAt.substr(11, 2), "\n          : ").concat(todo.updatedAt.substr(14, 2), "\uBD84 ").concat(str, ")\n      </span>\n      <div class=\"todos--button-wrapper\">\n        <div>\n          <button class=\"todos--delete-button\" value=").concat(todo.id, ">\uC0AD\uC81C\uD558\uAE30</button>\n          <button class=\"todos--update-button\" value=").concat(todo.id, ">\uD0C0\uD611\uD558\uAE30</button>\n        </div>\n      </div>\n      <div>").concat(todo.done === false ? "노력 중🔴" : "해냈어요!🔵", "\n        <button class='todos--done-toggle-button' value=").concat(todo.id, ">\uCCB4\uD06C</button>\n      </div>\n    </li>\n  ");
            });

          case 4:
            todoElements = _context10.sent;
            todoTitles = todoElements.join("");
            todoList.innerHTML = todoTitles;
            application.append(todoList);
            doneToggleButtons = document.querySelectorAll(".todos--done-toggle-button");
...
function _deleteDoneList() {
  _deleteDoneList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee11(e) {
    var _yield$axios2, data, doneTodo, todosIdArray;
...
function onToggleList(_x10) {
  return _onToggleList.apply(this, arguments);
}

function _onToggleList() {
  _onToggleList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee12(bool) {
    var _yield$axios3, data, filteredFalseData;
...
onInit();
},{"axios":"node_modules/axios/index.js","regenerator-runtime":"node_modules/regenerator-runtime/runtime.js","./app.mjs":"app.mjs","./main.css":"main.css"}],"../Users/owner/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
